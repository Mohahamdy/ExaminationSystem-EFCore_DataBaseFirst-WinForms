...
namespace DB_Sytem {
    ...
    public partial class courseDataSet : global::System.Data.DataSet {
        ...
        public partial class courseDataTable : global::System.Data.TypedTableBase<courseRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public courseRow AddcourseRow(string name, int duration, int grade) {
...
namespace DB_Sytem.courseDataSetTableAdapters {
    ...
    public partial class courseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[course] WHERE (([course_ID] = @Original_course_ID) AND ([name] = @Original_name) AND ((@IsNull_duration = 1 AND [duration] IS NULL) OR ([duration] = @Original_duration)) AND ((@IsNull_grade = 1 AND [grade] IS NULL) OR ([grade] = @Original_grade)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[course] ([name], [duration], [grade]) VALUES (@name, @duration" +
                ", @grade);\r\nSELECT course_ID, name, duration, grade FROM course WHERE (course_ID" +
                " = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[course] SET [name] = @name, [duration] = @duration, [grade] = @grade WHERE (([course_ID] = @Original_course_ID) AND ([name] = @Original_name) AND ((@IsNull_duration = 1 AND [duration] IS NULL) OR ([duration] = @Original_duration)) AND ((@IsNull_grade = 1 AND [grade] IS NULL) OR ([grade] = @Original_grade)));
SELECT course_ID, name, duration, grade FROM course WHERE (course_ID = @course_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT course_ID, name, duration, grade FROM dbo.course";
        ...
        public virtual int Delete(int Original_course_ID, string Original_name, global::System.Nullable<int> Original_duration, global::System.Nullable<int> Original_grade) {
        ...
        public virtual int Insert(string name, global::System.Nullable<int> duration, global::System.Nullable<int> grade) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, global::System.Nullable<int> duration, global::System.Nullable<int> grade, int Original_course_ID, string Original_name, global::System.Nullable<int> Original_duration, global::System.Nullable<int> Original_grade, int course_ID) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, global::System.Nullable<int> duration, global::System.Nullable<int> grade, int Original_course_ID, string Original_name, global::System.Nullable<int> Original_duration, global::System.Nullable<int> Original_grade) {
            return this.Update(name, duration, grade, Original_course_ID, Original_name, Original_duration, Original_grade, Original_course_ID);
        }
    }
